...
/**
 * This is a copy DefaultItemAnimator
 *
 * The reason why we're not extending that class is because for some mysterious reason
 * animateRemoveImpl is marked as private there, while the rest of animations are not.
 */
public class BaseItemAnimator extends SimpleItemAnimator {
  ...
  private static class ChangeInfo {
    ...
    ChangeInfo(RecyclerView.ViewHolder oldHolder, RecyclerView.ViewHolder newHolder, int fromX,
  ...
  @Override
  public boolean animateMove(final RecyclerView.ViewHolder holder, int fromX, int fromY, int toX,
      int toY) {
    final View view = holder.itemView;
  ...
  private void resetAnimation(RecyclerView.ViewHolder holder) {
    ...
    holder.itemView.animate()
        .setInterpolator(sDefaultInterpolator);
    endAnimation(holder);
  }
  ...
  void cancelAll(List<RecyclerView.ViewHolder> viewHolders) {
    for (int i = viewHolders.size() - 1; i >= 0; i--) {
      viewHolders.get(i).itemView.animate()
          .cancel();
    }
  }
   ...
   * then DefaultItemAnimator will call {@link #animateMove(RecyclerView.ViewHolder, int, int, int,
   * int)} and
